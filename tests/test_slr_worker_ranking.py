...
class TestSLRWorkerRanking(MockedEventDrivenServiceStreamTestCase):
    ...
    MOCKED_STREAMS_DICT = {
        SERVICE_STREAM_KEY: [],
        'cg-SLRWorkerRanking': MOCKED_CG_STREAM_DICT,
    }

    @patch('slr_worker_ranking.service.SLRWorkerRanking.process_event_type')
